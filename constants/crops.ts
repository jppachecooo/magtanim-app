  ...
  const crops = [
    {
      ...
      descriptions: t("tomatoDescriptions", { returnObjects: true }),
      category: t("vegetable"),
      spacing: "18-24 in",
      depth: "¼ in",
      water: "1",
      season: t("wetDry"),
    ...
    },
    {
      ...
      descriptions: t("pumpkinDescriptions", { returnObjects: true }),
      category: t("vegetable"),
      spacing: "36-60 in",
      depth: "1-2 in",
      water: "1",
    ...
    },
    {
      ...
      description: t("lettuceDescription"),
      category: t("vegetable"),
      spacing: "6-18 in",
      depth: "¼-½ in",
      water: "2",
    ...
    },
    {
      ...
      description: t("cucumberDescription"),
      category: t("vegetable"),
      spacing: "12 in",
      depth: "1 in",
      water: "1",
    ...
    },
    {
      ...
      description: t("chilliDescription"),
      category: t("vegetable"),
      spacing: "15-18 in",
      depth: "¼ in",
      water: "2",
    ...
    },
    {
      ...
      background: require("@/assets/images/crops/turnip-bg.jpg"),
      description:
        "The tomato plant, with soft, hairy stems, can grow up to 9 feet tall, has 5-9 leaflets, 4-24 inches long leaves, and small yellow flowers with five pointed lobes on the corolla.",
      category: t("rootCrop"),
      spacing: "8-12 in",
